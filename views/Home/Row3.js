    ...
    <View style={{ backgroundColor: "white" }}>
      <View style={{ flex: 1, alignItems: "center" }}>
        ...
        <View style={{ width: "100%" }}>
          <Card>
            <Card.Image style={{ height: 300 }} source={require("../../assets/images/dropinc.jpg")} />
        ...
        <View style={{ width: "100%" }}>
          <Card>
            <Card.Image style={{ height: 300 }} source={require("../../assets/images/hotdeskc.jpg")} />
        ...
        <View style={{ width: "100%" }}>
          <Card>
            <Card.Image style={{ height: 300 }} source={require("../../assets/images/permentdeskc.jpg")} />
